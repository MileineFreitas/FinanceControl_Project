...
public static class FinanceDbContextSeed
{
    ...
    {
        if (db.TransactionTypes.Any()) return;

        db.TransactionTypes.AddRange(
            new TransactionTypeDefinition
            {
                TransactionTypeId = SeedIds.TransactionTypeDebito,
                Name = "Débito",
                Icon = "💳",
                IsSystem = true,
                IsActive = true
            ...
            new TransactionTypeDefinition
            {
                TransactionTypeId = SeedIds.TransactionTypeCredito,
                Name = "Crédito",
                Icon = "💳",
                IsSystem = true,
                IsActive = true
            ...
            new TransactionTypeDefinition
            {
                TransactionTypeId = SeedIds.TransactionTypeDinheiro,
                Name = "Dinheiro",
                Icon = "💵",
                IsSystem = true,
                IsActive = true
